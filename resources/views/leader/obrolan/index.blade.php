...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12">
            ...
            <p class="text-muted">Chat dengan tim dan anggota</p>
        </div>
    </div>
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body" style="height: 400px; overflow-y: auto;">
                    <div class="mb-3">
                        <small class="text-muted">10:15 - Budi Santoso</small>
                        <p>Halo, bagaimana kabar proyek?</p>
                    </div>
                </div>
