    ...
    <div class="navbar-container">
        ...
        <div class="navbar-search">
            <div class="search-wrapper">
                ...
                <input type="text" placeholder="Cari proyek, catatan...">
            </div>
        </div>
        ...
        <div class="navbar-right">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                <li><a class="dropdown-item" href="#"><i class="bi bi-info-circle"></i> Bimbingan Baru</a></li>
            ...
            <div class="navbar-user">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="{{ \App\Helpers\RouteHelper::getProfileRoute() }}"><i class="bi bi-person"></i> Profil Leader</a></li>
                    <li>
                        <hr class="dropdown-divider">
                    </li>
                    <li>
