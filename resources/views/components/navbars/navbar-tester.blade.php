    ...
    <div class="navbar-container">
        ...
        <div class="navbar-search">
            <div class="search-wrapper">
                ...
                <input type="text" placeholder="Cari laporan, tools...">
            </div>
        </div>
        ...
        <div class="navbar-right">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                <li><a class="dropdown-item" href="#"><i class="bi bi-exclamation-triangle"></i> Bug Baru</a></li>
                <li><a class="dropdown-item" href="#"><i class="bi bi-graph-up"></i> Monitoring Alert</a></li>
                <li>
            ...
            <div class="navbar-user">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="{{ \App\Helpers\RouteHelper::getProfileRoute() }}"><i class="bi bi-person"></i> Profil Tester</a></li>
                    <li>
                        <hr class="dropdown-divider">
                    </li>
                    <li>
