...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <p class="badge bg-warning">Tester</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-8">
                    ...
                    <form id="profileForm">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" value="Tester" disabled>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-12">
            ...
            <div class="card mt-3">
                <div class="card-header">
                    <h5 class="card-title mb-0">Statistik Tester</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function uploadAvatar(file) {
            ...
            fetch('{{ route("tester.profile.upload-avatar") }}', {
                    method: 'POST',
                    headers: {
        ...
        if (deleteAvatarBtn) {
            deleteAvatarBtn.addEventListener('click', (e) => {
                ...
                if (confirm('Apakah Anda yakin ingin menghapus avatar?')) {
                    fetch('{{ route("tester.profile.delete-avatar") }}', {
                            method: 'POST',
                            headers: {
                                'X-CSRF-TOKEN': document.querySelector('[name="_token"]').value,
        ...
        profileForm.addEventListener('submit', (e) => {
            ...
            fetch('{{ route("tester.profile.update") }}', {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': document.querySelector('[name="_token"]').value
                    },
